...
public class HachelListener {

    public static ItemStack createPirateHache() {
        ItemStack GLAIVE = new ItemStack(Material.DIAMOND_AXE);
        ItemMeta meta = GLAIVE.getItemMeta();

        meta.setCustomModelData(Integer.valueOf("10001"));
        meta.setDisplayName("§5§l✤ Hâche du Pirate ✤");
