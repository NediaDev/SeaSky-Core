...
public class BotteAquatiqueListener {

    public static ItemStack createBotteAquatique() {
        ItemStack CasqueAquatique = new ItemStack(Material.LEATHER_BOOTS);
        ...
        meta.setDisplayName("§f✦ §b§lBotte Aquatique §f✦");
